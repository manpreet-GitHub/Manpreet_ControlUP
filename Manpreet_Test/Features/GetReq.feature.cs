...
#line hidden
            ...
            else
            {
                this.ScenarioStart();
#line 7
 testRunner.Given("the user sends a get request with url as \"https://rapidapi.com/spamakashrajtech/a" +
                        "pi/corona-virus-world-and-india-data\"", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Given ");
#line hidden
#line 9
 testRunner.Then("request should be a success with 200s code", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
